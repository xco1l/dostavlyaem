...
UserRepository = __decorate([
    __param(0, core_1.inject('datasources.postgre')),
    __param(1, repository_1.repository(order_repository_1.OrderRepository)),
    __metadata("design:paramtypes", [datasources_1.PostgreDataSource,
